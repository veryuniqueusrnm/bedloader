...
public class MixinConfigPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("net.veryuniqueusrnm.bedloader.client.mixin.CapeFeatureRendererMixin")) {
            ...
            if (capes) {
                ...
                LoggerFactory.getLogger(MixinConfigPlugin.class).info("Disabling transparent cape mixin in BedLoader as another cape-related mod is also installed.");
                return false;
            }
        }
        return true;
